...
class plugin_info{
    ...
    static $PLUGIN_CODE         = "CAPTCHA";
    /** プラグイン名(必須)：プラグイン管理・画面出力（エラーメッセージetc）にはこの値が出力されます。 */
    static $PLUGIN_NAME         = "CAPTCHA";
    /** プラグインバージョン(必須) */
    ...
    static $AUTHOR              = "のぶ";
    /** 説明(必須) */
    static $DESCRIPTION         = "お問い合わせページにCAPTCHAを追加します";
    /** プラグインのサイトURL : 設定されている場合はプラグイン管理画面の作者名がリンクになります。 */
    static $PLUGIN_SITE_URL     = "https://github.com/nobuhiko/ECCUBE-CAPTCHA";
    /** 作者用のサイトURL：設定されている場合はプラグイン管理画面の作者名がリンクになります。 */
    static $AUTHOR_SITE_URL     = "http://wp.me/p2jTj1-1SU";
    /** プラグインメインクラス名(必須)：本体がプラグインを実行する際に呼ばれるクラス。拡張子は不要です。 */
    static $CLASS_NAME          = "CAPTCHA";
    /** フックポイント：フックポイントとコールバック関数を定義します */
    static $HOOK_POINTS       = array(
        array("LC_Page_Contact_action_after", 'contact_action_after'),
